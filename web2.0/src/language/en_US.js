const en_US = {
    ...
    Contact: 'Contact',
    Community: 'Community',
    Our_companion: 'Our companion',
    Security_Audit: 'Security Audit',
    Investor: 'Investor',
    Exchanges: 'Exchanges',
    Wallets: 'Wallets',
    Ecological: 'Eco-partners',
    ...
    Liquidity_Protocols__part2__title_2: 'DEX Aggregator with Best Market Price',
    ...
    DeFi_Full_Stacks: 'Super Liquidity Galaxy and Protocol Matrix',
    DeFi_Full_Stacks__content: 'dForce advocates for building an integrated and interoperable and scalable open finance protocol network, cultivating intra-protocol liquidity and network effects, while remain in full openness to interact and integrated with other protocols.',
